...
def test_environment():
    ...
    try:
        ...
        # Check if observation is dict (pixels mode) or array (features mode)
...
def capture_templates():
    ...
    try:
        ...
        print("\n2. Navigate to summit marker/flag (or view SUMMIT text)")
...
def test_training_setup():
    ...
    try:
        ...
        scripts = ['ppo_training.py', 'sac_training.py', 'model_watching.py', 'peak_env_wrapper.py']
        ...
        if all_found:
            ...
            print("\n⚠ Some files are missing. Make sure you have all required files.")
...
def display_info():
    ...
    print("   peak_env_wrapper.py - Action space wrapper")
    ...
    print("\n🎮 Training Commands:")
    print("   Basic PPO training (simplified actions):")
    print("     python ppo_training.py --use_simplified")
    print("\n   Advanced PPO with custom settings:")
    print("     python ppo_training.py --n_envs 8 --total_timesteps 2000000 --use_simplified")
    print("\n   SAC training:")
    print("     python sac_training.py --use_simplified")
    print("\n   Resume training:")
    ...
    print("\n💡 Tips:")
    print("   • Use --use_simplified for easier training")
  ...
  python setup_and_test.py --info          # Show information
    ...
    if results:
        ...
        if all_passed:
            ...
            print("2. Run: python ppo_training.py --use_simplified")
